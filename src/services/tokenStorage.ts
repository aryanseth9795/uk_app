...
// const useSecure = true; // set false to force AsyncStorage (dev only)

// async function setItem(key: string, value: string) {
//   if (useSecure) return SecureStore.setItemAsync(key, value, { keychainService: 'uk-ecom-auth' });
//   return AsyncStorage.setItem(key, value);
// }
// async function getItem(key: string) {
//   if (useSecure) return SecureStore.getItemAsync(key, { keychainService: 'uk-ecom-auth' });
//   return AsyncStorage.getItem(key);
// }
// async function delItem(key: string) {
//   if (useSecure) return SecureStore.deleteItemAsync(key, { keychainService: 'uk-ecom-auth' });
...
//   if (t.refreshToken !== undefined) await setItem(K.refreshToken, t.refreshToken ?? '');
